...
const Login = ({ onLogin }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      localStorage.setItem('codec_user_id', data.user.id || data.user._id); // Save user ID explicitly
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`
                    w-full pl-10 pr-3 py-3 rounded-lg border backdrop-blur-md transition-all duration-200
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center">
                <input
                  type="checkbox"
                  className="w-4 h-4 rounded border-white/10 bg-white/5 text-blue-400 focus:ring-blue-400/50 focus:outline-none"
                  disabled={isLoading}
                />
